...
const CommunicationTool = () => {
  ...
  return (
    <View style={styles.communicationTool}>
      <View style={[styles.ellipseParent, styles.ellipsePosition]}>
        ...
        <View style={styles.innovativeLearningForInclusParent}>
          <Text
            style={[styles.innovativeLearningFor, styles.innovativeFlexBox]}
          >
            Innovative Learning for Inclusive Horizons
          </Text>
          <View style={[styles.searchBar, styles.searchLayout2]}>
            <View
              style={[styles.searchBarChild, styles.rectangleViewShadowBox]}
            />
            <Image
      ...
      <View style={[styles.ellipseGroup, styles.ellipsePosition]}>
        ...
        />
        <Text style={[styles.innovativeLearningFor1, styles.innovativeFlexBox]}>
          Innovative Learning for Inclusive Horizons
        </Text>
        <Pressable
        ...
        <Text style={[styles.communicationTool1, styles.innovativeFlexBox]}>
          Communication Tool
        </Text>
        <Pressable
        ...
        <View style={[styles.speechToImageWrapper, styles.speechLayout]}>
          <Text style={[styles.speechToImage, styles.speechLayout]}>
            Speech to Image
          </Text>
        </View>
        <Image
        ...
        />
        <Image
          style={styles.pngwingcom441}
          contentFit="cover"
          source={require("../assets/pngwingcom-44-1.png")}
        />
      </View>
      <Image
      ...
      <View style={styles.communicationToolChild} />
      <Image
